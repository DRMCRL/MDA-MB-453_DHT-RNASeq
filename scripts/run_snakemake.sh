...
#SBATCH --mem=128GB
#SBATCH -o /home/a1018048/slurm/MDA-MB-453_DHT-RNASeq/%x_%j.out
#SBATCH -e /home/a1018048/slurm/MDA-MB-453_DHT-RNASeq/%x_%j.err
...
## Project Root
PROJ=${HPC}/users/a1018048/MDA-MB-453_DHT-RNASeq
